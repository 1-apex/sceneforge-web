          ...
          <div className="flex flex-wrap gap-5">
            ...
            >
              <button className="group relative px-14 py-7 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl font-black text-xl hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 transition-all duration-500 shadow-2xl shadow-blue-500/50 hover:shadow-purple-500/60 hover:scale-110 transform overflow-hidden">
                ...
                <span className="relative z-10">Create your own 3D Scene</span>
              </button>
            </a>
            <a href="/examples">
              <button className="group relative px-10 py-5 border-2 border-slate-600 rounded-2xl font-black text-lg hover:border-blue-400 transition-all duration-500 backdrop-blur-xl hover:scale-105 transform shadow-xl hover:shadow-2xl hover:shadow-blue-500/30 overflow-hidden">
